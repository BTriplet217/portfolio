...
var colors = ['#2f2e2f', '#c3073f', '#151415', '#950740', '#1a1a1a'];
...
var Game = {
    ...
    menu: function () {
        ...
        this.context.fillText('Press any key to play',
            this.canvas.width / 2,
    ...
    listen: function () {
        ...
        // Handle touch move event to control the paddle
        Pong.canvas.addEventListener('touchmove', function (e) {
            const touch = e.touches[0];
            const relativeY = touch.clientY - Pong.canvas.offsetTop;
            if (relativeY > 0 && relativeY < Pong.canvas.height) {
                Pong.player.y = relativeY - Pong.player.height / 2;
            }
        });
    },
